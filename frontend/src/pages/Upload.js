...
import { Upload as UploadIcon, FileVideo, Image, X, Tag, BookOpen, Code, CheckCircle } from 'lucide-react';  return (

    <div className="max-w-4xl mx-auto">

const Upload = () => {      <h1 className="text-3xl font-bold text-gray-900 mb-8">Upload Video</h1>

  const navigate = useNavigate();      <div className="bg-white rounded-xl p-8 shadow-lg">

  const [formData, setFormData] = useState({        <p className="text-gray-600">Video upload functionality coming soon...</p>
    ...
    semester: '',export default Upload;
    tags: '',
  });
