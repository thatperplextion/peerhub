            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-6">
                <div className="flex items-center gap-2">
                  <Eye size={18} className="animate-wiggle" />
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                <button
                  onClick={handleLike}
                  className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:scale-105 hover:animate-heartbeat transition-all shadow-md"
                >
                  <ThumbsUp size={20} />
                ...
                <button className="flex items-center gap-2 px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                  <Share2 size={20} className="animate-jiggle" />
                  <span>Share</span>
                </button>
                <button className="flex items-center gap-2 px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                  <Save size={20} className="animate-swing" />
                  <span>Save</span>
                </button>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900">{video.uploader?.name || 'Unknown'}</h3>
                  <p className="text-sm text-gray-600">{video.uploader?.department || ''}</p>
                </div>
              </div>
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-xl">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <span className="ml-2 font-medium text-gray-900">{video.courseCode}</span>
                    </div>
                    <div>
                      <span className="text-gray-600">Semester:</span>
                      <span className="ml-2 font-medium text-gray-900">{video.semester}</span>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div className="mt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {video.tags.map((tag, index) => (
                      <span
                        key={index}
                        className="px-4 py-2 bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 rounded-full text-sm font-medium hover:scale-105 transition-transform"
                      >
                        {tag}
                      </span>
                    ))}
              ...
              {(video.transcript || video.summary) && (
                <div className="mt-6">
                  ...
                  >
                    <FileText size={20} className="animate-jiggle" />
                    <span>{showTranscript ? 'Hide' : 'Show'} Transcript & Summary</span>
                  </button>
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      {video.transcript && (
                        <div className="p-4 bg-gray-50 rounded-xl max-h-64 overflow-y-auto">
                          ...
                          <p className="text-gray-700 text-sm whitespace-pre-wrap">{video.transcript}</p>
                        </div>
                      )}
                    </div>
                  )}
                ...
                {activeTab === 'comments' && (
                  <div className="space-y-6">
                    <form onSubmit={handleAddComment} className="flex gap-3">
                      ...
                      <button
                        type="submit"
                        className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:scale-105 transition-transform shadow-md"
                      >
                        <Send size={20} className="animate-jiggle" />
                      </button>
                    </form>

                    <div className="space-y-4">
                      {comments.map((comment) => (
                        <div key={comment._id} className="p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                              ...
                              <div className="flex-1">
                                ...
                                <div className="flex items-center gap-4 mt-2">
                                  <button className="flex items-center gap-1 text-sm text-gray-600 hover:text-purple-600">
                                    <ThumbsUp size={16} className="hover:animate-heartbeat" />
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-6">
                      {questions.map((question) => (
                        <div key={question._id} className="p-6 bg-gray-50 rounded-xl">
                          <div className="flex items-start gap-3 mb-4">
                            <HelpCircle size={24} className="text-purple-600 animate-spin-slow" />
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-2 text-xs text-gray-500">
                                <span>{question.askedBy?.name || 'Anonymous'}</span>
                                <span>•</span>
                          ...
                          <div className="ml-8 space-y-3">
                            {question.answers?.map((answer) => (
                              <div key={answer._id} className="p-4 bg-white rounded-lg border-l-4 border-purple-600">
                                <div className="flex items-start gap-3">
                                  <CheckCircle size={20} className="text-green-600 animate-heartbeat" />
                                  <div className="flex-1">
                            ...
                            <div className="flex gap-2">
                              ...
                              <button
                                ...
                                className="px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:scale-105 transition-transform text-sm"
                              >
                                Answer
                              </button>
                            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2">
                <TrendingUp size={20} className="text-purple-600 animate-bounce-slow" />
                Related Videos
              </h3>
              <div className="space-y-4">
                {relatedVideos.map((relatedVideo) => (
                  ...
                  >
                    <div className="w-40 h-24 bg-gradient-to-br from-purple-200 to-pink-200 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                      <Play size={32} className="text-white animate-heartbeat" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <h4 className="font-medium text-gray-900 text-sm line-clamp-2 group-hover:text-purple-600 transition-colors">
                        {relatedVideo.title}
                      </h4>
                      <p className="text-xs text-gray-600 mt-1">{relatedVideo.uploader?.name || 'Unknown'}</p>
